  ...
  <div class="register">
    <div class="form_container">
      <div class="manage_tip">
        <span class="title">社区图书馆管理系统职工注册</span>
      </div>
      <el-form :model="registerForm" status-icon :rules="rules" ref="registerForm" label-width="80px"
        ...
        <el-form-item label="手机号" prop="staff_phone">
          <el-input type="tel" v-model="registerForm.staff_phone" placeholder="请输入手机号"></el-input>
        </el-form-item>
        <el-form-item label="身份证号" prop="id_number">
          <el-input v-model="registerForm.id_number" placeholder="请输入身份证号"></el-input>
        </el-form-item>
        ...
        <el-form-item label="职务类型" prop="identity">
          <el-select v-model="registerForm.identity">
            <el-option label="图书管理" value="图书管理">
            </el-option>
            <el-option label="前台服务" value="前台服务">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="submitForm('registerForm')" class="submit_btn">提交</el-button>
        </el-form-item>
