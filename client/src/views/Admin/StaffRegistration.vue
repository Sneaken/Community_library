    ...
    <div class="form_container">
      ...
      >
        <el-form-item label="手机号" prop="staff_phone">
          <el-input
            type="tel"
            v-model="registerForm.staff_phone"
            placeholder="请输入手机号"
          ></el-input>
        </el-form-item>
        ...
        <el-form-item label="职务类型" prop="identity">
          <el-select v-model="registerForm.identity">
            <el-option label="图书管理" value="图书管理"> </el-option>
            <el-option label="前台服务" value="前台服务"> </el-option>
          </el-select>
        </el-form-item>
        <el-form-item>
          <el-button
    ...
    return {
      ...
      rules: {
        ...
        name: [
          ...
          identity:[{ required: true, message: "请选择", trigger: "blur" },]
      }
    };
  },
  methods: {
